...
get_currancy()
{
  ...
  myHeaders.append("apikey", "k6V1kiSPefekSRAwlzLbX8Z64UQA6Nnu");
  ...
  fetch(`https://api.apilayer.com/fixer/convert?from=${this.from_convert}&to=${this.to_convert}&amount=${this.amount}`, requestOptions)
  .then((response) => response.json())
  .then((data) => {
    this.curr = data.result;  // Display the converted amount
  })
